...
public class ModCommonConfig {
    ...
    static {
        ...
        ROAD_SALT_PRESERVATION = BUILDER.comment("How quickly road salt should be used up. Default: 32, set to -1 to disable (road salt always persists)")
            .defineInRange("gameplay.road_salt.preservation", 32, -1, Short.MAX_VALUE);
        ROAD_SALT_RANGE = BUILDER.comment("The range of road salt in which snow melts.")
            .defineInRange("gameplay.road_salt.range", 3, 1, 8);
        ROAD_SALT_SPEED = BUILDER.comment("The base speed of the road salt.")
            .defineInRange("gameplay.road_salt.speed", 100, 1, Integer.MAX_VALUE);
