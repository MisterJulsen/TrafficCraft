...
public class HorizontalScrollBar extends DragonLibWidgetBase implements IExtendedAreaWidget { 
    ...
    public void renderWidget(GuiGraphics graphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        for (int i = 0; i < w - 4; i += 2) {
            GuiUtils.blit(DragonLibConstants.UI, graphics, x1 + 2 + i, y1 + 2, i < w - 4 ? 2 : 1, h - 4, startU + 2, startV + 2, i < w - 4 ? 2 : 1, 1, DynamicGuiRenderer.TEXTURE_WIDTH, DynamicGuiRenderer.TEXTURE_HEIGHT);
        }
    }
