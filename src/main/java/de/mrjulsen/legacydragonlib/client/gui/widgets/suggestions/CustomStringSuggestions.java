package de.mrjulsen.legacydragonlib.client.gui.widgets.suggestions;
...
public class CustomStringSuggestions extends CommandSuggestions {
	...
	public CustomStringSuggestions(Minecraft pMinecraft, Screen pScreen, EditBox pInput, Font pFont, List<String> viableStations, int yOffset) {
